...
\title{\huge Hazard Analysis \\ \progname}
...
\begin{longtable}{| p{0.14\textwidth} | p{0.04\textwidth}| p{0.15\textwidth}| p{0.20\textwidth}| p{0.20\textwidth}| p{0.18\textwidth}|}
    \hline
    \rowcolor[gray]{0.9}
    \textbf{Component} 
    & \textbf{Ref}
    ...
    Data \newline Dashboard & H4.\refstepcounter{fmeanumDAW}\thefmeanumDAW
    & User cannot login
