...
\title{Reflection Report \\ \progname}
...
Added updated pictures of GUI in system design \\

Added new functions when describing ui functions.py module in MIS \\

Added new module generate arduino code in MIS\\
