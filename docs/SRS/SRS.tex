...
\subsubsection{Usability} 
    ...
    The user will be able to learn the device's operation quickly to integrate into their testing workflow efficiently. If the user waches an educational product video and is able to complete the test setup and navigate the user interface without re-watching the educational video, the ease of learning requirement can be considered to be accomplished
