...
\begin{itemize}
  ...
  \begin{description} \item[Rationale] tEST \end{description}
...
\begin{itemize}
  ...
  \subitem[\textbf Rationale:] The device should contain a rechargeable battery
  ...
  \item[FR\refstepcounter{reqnum}\thereqnum:] 
