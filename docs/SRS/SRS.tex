...
\item[LC\refstepcounter{lcnum}\thelcnum\label{LC_meaningfulLabel}:] Method to start and stop the test on the device
...
\item[LC\refstepcounter{lcnum}\thelcnum\label{LC_meaningfulLabel}:] The initial data we are collecting (Vibration, Shock, Temperature, Humidity)
...
\item[LC\refstepcounter{lcnum}\thelcnum\label{LC_meaningfulLabel}:] The number of modular ports on the device
...
\begin{enumerate}
  \item \textbf{Sensors/Embedded Systems:} To successfully complete this project our group needs to collectivly understand how sensors and microcontrollers work.
...
\begin{enumerate}
  \item \textbf{Sensors/Embedded Systems:} Ahmed
