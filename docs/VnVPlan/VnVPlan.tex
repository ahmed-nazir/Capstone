...
Output/Result: Users will either be allowed to continue test or not depending of the compatability of the test to our device.
					
How test will be performed: Users will begin testing doing different tests with different equipment and based on the the compatability of the equipment to the test this it will either allow you or stop you from running the test to help avoid 
