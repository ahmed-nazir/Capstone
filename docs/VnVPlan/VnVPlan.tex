...
\begin{enumerate}
  ...
  How test will be performed: While the deivce is connected to the PC the start button will be pressed to check if telemetry data is being sent to the PC\\
  ...
  \begin{enumerate}
    ...
    Input: The temperature sensor is connected and start is pressed
              
    Output: The device should start sending data to the PC
    
    %Test Case Derivation: \wss{Justify the expected value given in the Output field}
              
    How test will be performed: While the device is connected to the PC the temperature sensor is connected to the modular port on the device and the start button is pressed\\
...
\begin{tabular}{| p{0.45\textwidth} | p{0.45\textwidth}|}
  ...
  \hline
  FR 2 & ST-DT 1, ST-DT 2 \\
  \hline
  FR 3 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 4 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 5 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 6 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 7 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 8 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 9 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 10 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 11 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 12 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 13 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 14 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 15 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 16 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 17 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 18 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 19 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 20 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 21 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 22 & ST-SV 1, ST-SV 2 \\
  \hline
  FR 23 & ST-SV 1, ST-SV 2 \\
  \hline
